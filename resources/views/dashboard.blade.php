                  ...
                  <div class="card-body pb-0">
                    ...
                    <table class="table table-borderless">
                      ...
                      <tbody>
                        <tr>
                          <th scope="row">
                            <a href="#"><img src="{{ asset('NiceAdmin/assets/img/product-1.jpg') }}" alt="" /></a>
                          </th>
                        ...
                        <tr>
                          <th scope="row">
                            <a href="#"><img src="{{ asset('NiceAdmin/assets/img/product-2.jpg') }}" alt="" /></a>
                          </th>
                        ...
                        <tr>
                          <th scope="row">
                            <a href="#"><img src="{{ asset('NiceAdmin/assets/img/product-3.jpg') }}" alt="" /></a>
                          </th>
                        ...
                        <tr>
                          <th scope="row">
                            <a href="#"><img src="{{ asset('NiceAdmin/assets/img/product-4.jpg') }}" alt="" /></a>
                          </th>
                        ...
                        <tr>
                          <th scope="row">
                            <a href="#"><img src="{{ asset('NiceAdmin/assets/img/product-5.jpg') }}" alt="" /></a>
                          </th>
